    ...
    <div class="col-lg-6 mx-auto">
      ...
      <ol class="list-unstyled">
        ...
        <li>端点使能“大事件”按钮。</li>
        <li>用户点击“大事件”按钮，Bootstrap 将自动展示模态框中的内容。</li>
        <li>用户点击页面底部的“关闭本示例”按钮后，端点收到 `click` 事件。</li>
        <li>端点向 xGUI Pro 发送销毁窗口的请求。</li>
        <li>窗口消失，端点退出程序执行。</li>
      </ol>
      <div class="d-grid gap-2 d-sm-flex justify-content-sm-center mb-5">
        <button hvml-handle="A1" id="btnShowModal" type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#exampleModal" disabled>大事件</button>
