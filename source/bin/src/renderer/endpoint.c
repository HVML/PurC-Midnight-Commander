...
static struct request_handler {
    ...
    { PCRDR_OPERATION_GETPROPERTY, NULL },
    ...
    { PCRDR_OPERATION_SETPAGEGROUPS, NULL },
    { PCRDR_OPERATION_SETPROPERTY, NULL },
    ...
    { PCRDR_OPERATION_UPDATEWIDGET, NULL },
