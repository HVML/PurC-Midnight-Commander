...
CALCULATE_LIBRARY_VERSIONS_FROM_LIBTOOL_TRIPLE(PURCMC 0 0 0)
...
set(PURCMC_HEADER_INSTALL_DIR "${CMAKE_INSTALL_INCLUDEDIR}/purcmc" CACHE PATH "Absolute path to PurcMC header installation directory")

add_definitions(-DBUILDING_LINUX__=1)
add_definitions(-DPURCMC_API_VERSION_STRING="${PURCMC_API_VERSION}")
...
# and the option is not relevant to any other PurcMC ports.
#PURCMC_OPTION_DEFINE(USE_SYSTEMD "Whether to enable journald logging" PUBLIC ON)

# Private options specific to the HybridOS port. Changing these options is
# completely unsupported. They are intended for use only by PurcMC developers.
#PURCMC_OPTION_DEFINE(USE_ANGLE_WEBGL "Whether to use ANGLE as WebGL backend." PRIVATE OFF)
#PURCMC_OPTION_DEPEND(ENABLE_WEBGL ENABLE_GRAPHICS_CONTEXT_GL)

PURCMC_OPTION_DEFAULT_PORT_VALUE(ENABLE_XML PUBLIC ${ENABLE_XML_DEFAULT})
PURCMC_OPTION_DEFAULT_PORT_VALUE(ENABLE_HTTP PUBLIC ${ENABLE_HTTP_DEFAULT})
PURCMC_OPTION_DEFAULT_PORT_VALUE(ENABLE_LSQL PUBLIC ${ENABLE_LSQL_DEFAULT})
PURCMC_OPTION_DEFAULT_PORT_VALUE(ENABLE_RSQL PUBLIC ${ENABLE_RSQL_DEFAULT})
PURCMC_OPTION_DEFAULT_PORT_VALUE(ENABLE_HIBUS PUBLIC ${ENABLE_HIBUS_DEFAULT})
PURCMC_OPTION_DEFAULT_PORT_VALUE(ENABLE_SSL PUBLIC ${ENABLE_SSL_DEFAULT})
